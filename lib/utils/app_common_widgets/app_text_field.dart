  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        cursorColor: widget.cursorColor ?? AppLightColors.primary_color,
  ...
  return AppTextFied(
    ...
    paddingALl??
        EdgeInsets.symmetric(
            horizontal: AppConfig(context).width * 0.03,
            vertical: height ?? AppConfig(context).height * 0.016),
    borderRadius:borderRadius?? BorderRadius.circular(10),
    borderRadius2:borderRadius?? BorderRadius.circular(10),
    borderColor:border?? AppLightColors.border_color,
    borderColor1:border?? AppLightColors.border_color,
    hint: hint ?? "",
    hintColor:hintColor?? AppLightColors.border_color,
    ...
    borderColor2:border?? AppLightColors.primary_color,
    maxLines: max ?? 1,
  );
}