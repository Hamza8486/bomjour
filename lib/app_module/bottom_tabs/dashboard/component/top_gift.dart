...
class TopGift extends StatelessWidget {
            ...
            return Padding(
              ...
              child: SizedBox(
                ...
                child: GestureDetector(
                  onTap: (){
                    print(dashboardController.productsList[index].productId.toString());
                  ...
                  child: giftCommonWidget(sale: false,

                  context: context,
                    title: "${dashboardController.productsList[index].productName.toString()}",
                    ...
                    (wishController.wishListData
                        .where((element) =>
                    element.productId == dashboardController.productsList[index].productId)
                        .toList())
                        .isEmpty
                        ?
